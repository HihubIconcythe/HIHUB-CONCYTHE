...
local Tabs = {
    ...
    Stats = Window:AddTab({ Title = "Stats", Icon = "tráid đất" }),
    Player = Window:AddTab({ Title = "Player", Icon = "gấu" }),
    Teleport = Window:AddTab({ Title = "Teleport", Icon = "cánh cửa" }),
    Fruit = Window:AddTab({ Title = "Devil Fruit", Icon = "kiwi" }),
    Raid = Window:AddTab({ Title = "Dungeon", Icon = "sword" }),
    Race = Window:AddTab({ Title = "Race V4", Icon = "người máy" }),
    Shop = Window:AddTab({ Title = "Shop", Icon = "shopping" }),
	Misc = Window:AddTab({ Title = "Misc", Icon = "bost" }),
   Mele = Window:AddTab({ Title = "kaitun", Icon =  "wait" }).        
}
...
CFramMon = CFrame.new(167.978516, 26.2254658, -12238.874, -0.939700961, 0, 0.341998369, 0, 1, 0, -0.341998369, 0, -0.939700961)
